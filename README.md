...
Чтобы логика стала понятней см. реализацию.
...
Обрезает строку до указанного размера и вставляет заглушку в конце, по умолчанию - многоточие. Используется там, где не получается сделать это силами CSS.
